...
name: my-skill
description: >
  Brief description of the domain and when to use this skill.
  Be specific about both capabilities AND use cases — this is the primary
  signal Copilot uses to decide when to auto-load the skill. Max 1024 chars.
